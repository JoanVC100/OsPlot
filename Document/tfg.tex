...
l'apartat \ref{subsec:maquina-trigger}.  A més, s'afegirà la
...
S'incorporarà la màquina d'estats al programa d'Arduino mitjançant un
bucle després d'inicialitzar els perifèrics.  Aquesta màquina d'estats
dictarà quan s'envia a través del port sèrie les mostres capturades.
